...
public abstract class ANaviJedisDriver extends ANaviDriver {


    public ANaviJedisDriver(ServerAddress server, String auth) {
        super(server, auth);
    }

    public ANaviJedisDriver(ServerAddress server, String auth, NaviPoolConfig poolConfig) {
