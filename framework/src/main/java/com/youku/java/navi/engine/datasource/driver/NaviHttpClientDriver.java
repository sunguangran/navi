...
public class NaviHttpClientDriver extends AbstractNaviDriver {
    ...
    public NaviHttpClientDriver(ServerUrlUtil.ServerUrl server, String auth, NaviPoolConfig poolConfig) {
        ...
        if (poolConfig instanceof NaviHttpPoolConfig) {
            ...
            cm = new PoolingClientConnectionManager(
                SchemeRegistryFactory.createDefault(), 3000, TimeUnit.MILLISECONDS
            );
        }
